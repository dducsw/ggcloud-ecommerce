...
def run(argv=None):
    ...
    parser.add_argument("--job_name", default="clickstream-processing-v1")
    parser.add_argument("--temp_location", required=True)
    parser.add_argument("--staging_location", required=True)
    parser.add_argument("--max_workers", type=int, default=5, help="Maximum number of workers for autoscaling")
    ...
    parser.add_argument("--product_lookup_dataset", default="thelook_datawarehouse")
    parser.add_argument("--product_lookup_table", default="dim_products")
